    ...
    <validator name="loginValidator">
      <div class="form" @keyup.enter="loginRequest">
        ...
        <p>
          ...
          <input id="userName" type="text" name="userName" placeholder="用户名" v-model="userName" initial="off" detect-change="off" detect-blur="off" v-validate:user-name="userRule">
        ...
        <p>
          ...
          <input id="password" type="password" placeholder="密码" v-model="password" initial="off" detect-change="off" detect-blur="off" v-validate:password="passwordRule">
